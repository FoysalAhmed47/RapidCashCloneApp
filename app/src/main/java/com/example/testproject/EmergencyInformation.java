    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitlater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmergencyInformation.this, DescriptionInformationActivity.class);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmergencyInformation.this, WorkInformation.class);
                startActivity(intent);
            }
        });
        ...
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmergencyInformation.this, OnlineServiceActivity.class);
                startActivity(intent);
            }
        });
